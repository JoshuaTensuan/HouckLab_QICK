...
Run from repo root:
  python -m WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments._loopback_check_ZeroSpanParity
...
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.utils import chunked_acquire
...
def test_validation_rules_fire(soc, soccfg):
    from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mZeroSpanParity import _validate_cfg
    bad = _base_cfg()
