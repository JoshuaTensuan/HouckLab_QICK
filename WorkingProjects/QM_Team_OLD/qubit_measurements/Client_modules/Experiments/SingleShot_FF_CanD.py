...
import time
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mTransmissionFF import (
    CavitySpecFF,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSingleTone import (
    SingleTone,
)

from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSpecSliceFF import (
    QubitSpecSliceFF,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF import (
    AmplitudeRabiFF,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF_noUpdate import (
    AmplitudeRabiFF_N,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mChiShift import (
    ChiShift,
)

from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT1FF import (
    T1FF,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT2R import (
    T2R,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT2EFF import (
    T2EMUX,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSingleShotProgramFFMUX import (
    SingleShotProgramFFMUX,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT1_SS import (
    T1_SS,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mOptimizeReadoutandPulse_FF import (
    ReadOpt_wSingleShotFF,
    QubitPulseOpt_wSingleShotFF,
)
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mConstant2Tone import (
    ConstantTwoTone,
)
...
Qubit_Parameters = {
    "1": {
        "Readout": {"Frequency": 6582.385, "Gain": 8000}, # 1200
        "Qubit": {
            "Frequency": 2550.30,
            "Gain": 8000,
            "sigma": 2,
        ...
        "outerfoldername": "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q1/",
    },
    "2": {
        "Readout": {"Frequency": 6673.29, "Gain": 2000},
        "Qubit": {
            "Frequency": 2846.4,
            "Gain": 5000,
            "sigma": 2,
    ...
    "3": {
        ...
        "outerfoldername": "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q3/",
    },
    "4": {
        ...
        "outerfoldername": "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q4/",
    },
    "5": {
        "Readout": {"Frequency": 6992.12, "Gain": 2000},
        "Qubit": {
            "Frequency": 3294.9,
            "Gain": 1820,
            "sigma": 0.5,
        ...
        "outerfoldername": "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q5/",
    },
    "6": {
        "Readout": {"Frequency": 7066.89, "Gain": 1200},
        "Qubit": {
            "Frequency": 3577.4,
            "Gain": 2680,
            "sigma": 0.5,
        ...
        "outerfoldername": "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q6/",
    },
}
...
ChiShift_params = {
    ...
    "TransSpan": 10,  ### MHz, span will be center+/- this parameter
    "TransNumPoints": 81,
    "cavity_shift": 0.2,
    "relax_delay": 4000,
}
