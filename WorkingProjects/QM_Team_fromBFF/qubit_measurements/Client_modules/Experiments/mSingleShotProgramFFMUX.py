...
class SingleShotProgram(AveragerProgram):
    ...
    def initialize(self):
        ...
        # by ModifiedRamsey/ActiveResetVerify. Keep their physical integration
        # windows identical on the BFE firmware by converting each duration in
        # its owning hardware clock domain.
