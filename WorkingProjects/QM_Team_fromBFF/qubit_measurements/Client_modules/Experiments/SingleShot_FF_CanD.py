...
# ############## TATQ01-CL-KOH ############################
# Qubit_Parameters = {
#     '1': {'Readout': {'Frequency': 6582.381, 'Gain': 2500},
#           'Qubit': {'Frequency': 2550.30, 'Gain': 8000, "sigma": 1, "flattop_length": 1},
#           'outerfoldername':"Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q1/"},
#     '2': {'Readout': {'Frequency': 6673.27, 'Gain': 2500},
#           'Qubit': {'Frequency': 2847.5, 'Gain': 1200, "sigma": 0.1, "flattop_length": None}, #PI: 1200
#           'outerfoldername':"Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q2/"},
#     '3': {'Readout': {'Frequency': 6792.4, 'Gain': 4000},
#           'Qubit': {'Frequency': 3130.44, 'Gain': 2060, "sigma": 1, "flattop_length": None},
#           'outerfoldername': "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q3/"},
#     '4': {'Readout': {'Frequency': 6882.394, 'Gain': 4000}, # 1280.6 for Qubit sweep
#           'Qubit': {'Frequency': 3335.20, 'Gain': 8000, "sigma": 2, "flattop_length": None}, # sigma 1 flattop 1 pi gain: 5000 qubit frequency: 1280.57
#           'outerfoldername': "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q4/"},
#     '5': {'Readout': {'Frequency': 6992.13, 'Gain': 2500},
#           'Qubit': {'Frequency': 3293.7, 'Gain': 1000, "sigma": 0.01, "flattop_length": None},
#           'outerfoldername': "Z:/t1Team/Data/2026-05-18_BFE_cooldown/TATQ01-CL01-KOH/RFSOC/Q5/"},
#     '6': {'Readout': {'Frequency': 7066.9, 'Gain': 2000},  # 1280.6 for Qubit sweep
#           'Qubit': {'Frequency': 3593.99, 'Gain': 4000, "sigma": 0.15, "flattop_length": None},
#           # sigma 1 flattop 1 pi gain: 5000 qubit frequency: 1280.57
...
Spec_relevant_params = {"qubit_gain": 8000, "SpecSpan": 3, "SpecNumPoints": 201,
                        "reps": 10, 'rounds': 10,
                        'Gauss': True, "sigma": 1.4, "gain": 8000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
#
RunChiShift = False
...
RunT2E = True
T2E_params = {"T2_max_us": 10000, "T2_expts": 50, "T2_reps": 20, "T2_rounds": 20, "freq_shift": 0.0,
               "relax_delay": 8000, 'num_pi_pulses': 1, #need odd number of pulses
               "pi2_gain": 1200,
              "rotation_angle": None,
              "min_max": None,
              'repetitions': 1000}
...
SingleShot = False
SS_params = {"Shots": 2000, "Readout_Time": 15, "ADC_Offset": 1.0, "Qubit_Pulse": [Qubit_Pulse],
...
SS_R_params = {"gain_start": 100, "gain_stop": 6000, "gain_pts": 10, "span": 1, "trans_pts": 5}

SingleShot_QubitOptimize = False #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.5, "q_gain_pts": 5, "q_freq_span": 0.1, "q_freq_pts": 5,
