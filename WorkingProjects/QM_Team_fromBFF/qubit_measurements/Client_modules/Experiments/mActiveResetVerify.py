...
class ActiveResetVerifyProgram(AveragerProgram):
    ...
    def initialize(self):
        ...
        # Match ModifiedRamsey exactly while remaining on the BFE QICK-v1 API:
        # ADC windows use the readout clock, resonator pulses use the generator
        # fabric clock, and trigger/delay values use the tProc clock.
...
class ActiveResetVerify(ExperimentClass):
    ...
    def display(self, data=None, plotDisp=False, figNum=1, **kwargs):
        ...
        cond = (
            ...
            f"reset={'ON' if use_active_reset else 'OFF'}"
        )
