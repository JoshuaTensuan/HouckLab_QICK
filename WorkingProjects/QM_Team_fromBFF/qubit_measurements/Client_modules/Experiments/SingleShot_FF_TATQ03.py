...
import time
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mTransmissionFF import CavitySpecFF
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSingleTone import SingleTone

from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSpecSliceFF import QubitSpecSliceFF
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF import AmplitudeRabiFF
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF_noUpdate import AmplitudeRabiFF_N
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mChiShift import ChiShift

from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT1FF import T1FF
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT2R import T2R
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT2EFF import T2EMUX
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mSingleShotProgramFFMUX import SingleShotProgramFFMUX
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mT1_SS import T1_SS
from WorkingProjects.QM_Team_OLD.qubit_measurements.Client_modules.Experiments.mOptimizeReadoutandPulse_FF import ReadOpt_wSingleShotFF, QubitPulseOpt_wSingleShotFF
...
Qubit_Parameters = {
    ...
    '2': {'Readout': {'Frequency': 6786.11, 'Gain': 9000},
          'Qubit': {'Frequency': 3603.92, 'Gain': 5500, "sigma": 1.8, "flattop_length": 4},
    ...
    '4': {'Readout': {'Frequency': 6982.64, 'Gain': 9500},
          'Qubit': {'Frequency': 3965.75, 'Gain': 1900, "sigma": 0.3, "flattop_length": None},
          'outerfoldername': "Z:/t1Team/Data/2026-02-22_BFF_cooldown/TATQ01-3minHF-10secKOH-02/RFSOC/Q4/"},

    '5': {'Readout': {'Frequency': 7098.65, 'Gain': 10000},
          'Qubit': {'Frequency': 4030.9, 'Gain': 4800, "sigma": 0.6, "flattop_length": None},
          'outerfoldername': "Z:/t1Team/Data/2026-02-22_BFF_cooldown/TATQ01-3minHF-10secKOH-02/RFSOC/Q5/"},

    '6': {'Readout': {'Frequency': 7158.91, 'Gain': 5000},
          'Qubit': {'Frequency': 4220.82, 'Gain': 5560, "sigma": 0.9, "flattop_length": None},
          'outerfoldername': "Z:/t1Team/Data/2026-02-22_BFF_cooldown/TATQ01-3minHF-10secKOH-02/RFSOC/Q6/"}
}
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 10000, "SpecSpan": 5, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 10,
...
SS_R_params = {"gain_start": 5000, "gain_stop": 10000, "gain_pts": 7, "span": 1, "trans_pts": 7}

SingleShot_QubitOptimize = False  #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.5, "q_gain_pts": 5, "q_freq_span": 0.7, "q_freq_pts": 5,
